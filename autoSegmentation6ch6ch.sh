...
do
    ...
    python3 segmentationUnet6ch6chAtOnce.py $sourceRight $refRight $WEIGHT $saveRight -g $id
    ...
    python3 segmentationUnet6ch6chAtOnce.py $sourceLeft $refLeft  $WEIGHT $saveLeft -g $id
