...
# AABB/nonBlack->notAligned, nonLinear->nonLinear, withLinear->withLinear

#Input
readonly DATA="$HOME/Desktop/data/box/withLinear"
readonly SAVE="$HOME/Desktop/data/slice/withLinear"
